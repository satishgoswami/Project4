...
public class HTMLUtility {
     ...
     */
        ...
        StringBuffer sb = new StringBuffer
        		("<select style='width: 173px;  height: 19px;' class='form-control' name='" + name + "'>");
     ...
     */
        ...
        StringBuffer sb = new StringBuffer("<select style='width: 173px;  height: 19px;' class='form-control' name='" + name + "'>");
